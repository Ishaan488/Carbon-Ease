...
function calculateFootprint() {
    ...
    if (totalDailyFootprint < 10) {
        message = "Great job! Your carbon footprint is relatively low.";
        message += "<ul>";
        message += "<li>Keep up the good work! Continue using energy-efficient appliances.</li>";
        message += "<li>Unplug devices when not in use to save even more energy.</li>";
        message += "<li>Consider using reusable products (e.g., water bottles, shopping bags) to further reduce waste.</li>";
        message += "</ul>";
    } else if (totalDailyFootprint < 20) {
        message = "Your carbon footprint is moderate. Consider ways to reduce it.";
        message += "<ul>";
        message += "<li>Turn off lights when you leave a room, and use LED bulbs to save energy.</li>";
        message += "<li>Try a 'Meatless Monday' to reduce your carbon footprint from food.</li>";
        message += "<li>Use public transportation, carpool, or try biking for short distances.</li>";
        message += "<li>Reduce heating and cooling costs by adjusting your thermostat by 1-2 degrees.</li>";
        message += "</ul>";
    } else {
        message = "Your carbon footprint is high. Please look into reducing your emissions.";
        message += "<ul>";
        message += "<li>Switch to a renewable energy plan if available, or consider installing solar panels.</li>";
        message += "<li>Drive less by planning your trips or exploring remote work options.</li>";
        message += "<li>Limit air travel, and consider carbon offsets if you must fly.</li>";
        message += "<li>Invest in energy-efficient appliances like washing machines and refrigerators.</li>";
        message += "<li>Reduce water heating costs by using cold water for laundry and taking shorter showers.</li>";
        message += "</ul>";
    }
